...
product.oldPrice = (document.querySelector(".basisPrice .a-offscreen") || {}).textContent || (document.querySelector(".a-price .a-offscreen") || {}).textContent || "";
product.price = (document.querySelector(".a-price .a-offscreen") || {}).textContent || "";
product.brand = ((document.querySelector(".a-section #bylineInfo") || {}).textContent.split(":")[1] || "").trim();
product.image = (document.querySelector("#imgTagWrapperId img") || {}).getAttribute("src") || "";
